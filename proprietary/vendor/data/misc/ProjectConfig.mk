...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE = MTK_FUSED_LOCATION_SUPPORT MAXIM_SPEAKER_SUPPORT MTK_CAM_ZSDHDR_SUPPORT MTK_CAM_ZSDMFB_SUPPORT SIM_ME_LOCK_MODE CUSTOM_CONFIG_MAX_DRAM_SIZE MTK_MD_SBP_CUSTOM_VALUE MTK_CAM_MFB_SUPPORT MTK_CAM_CONTINUOUS_SHOT_MODE MTK_NFC_SE_NUM MTK_SIM1_SOCKET_TYPE MTK_SIM2_SOCKET_TYPE  MTK_LCM_PHYSICAL_ROTATION LCM_WIDTH MTK_EXTERNAL_MODEM_SLOT LCM_HEIGHT  MTK_LCM_PHYSICAL_ROTATION LCM_WIDTH MTK_EXTERNAL_MODEM_SLOT LCM_HEIGHT
...
#HQ-yangzhicheng modify HQ-63863 add for MSSI begin
MTK_DMC_SUPPORT = yes
MSSI_MTK_MAPI_SUPPORT = yes
MTK_MAPI_SUPPORT = yes
#HQ-yangzhicheng modify HQ-63863 add for MSSI end
...
NAND_OTP_SUPPORT = no
ifneq ($(filter ro.miui.customized.region=mx_telcel, $(subst @, ,$(BUILD_MIUI_CUSTOMIZED_PROP))),)
MTK_SPECIFIC_SM_CAUSE = yes
MTK_CC33_SUPPORT = yes
MTK_MD_SBP_CUSTOM_VALUE = 0x70
OPTR_SPEC_SEG_DEF = OP112_SPEC0200_SEGDEFAULT
else
...
CONFIG_NFC=y
CONFIG_NFC_PN553_19A_DEVICES=y
MTK_VENDOR_CAM_ID_FIX = yes
MTK_TEE_GP_SUPPORT = yes
MTK_LK_FIRSTLCM_SUPPORT = yes
